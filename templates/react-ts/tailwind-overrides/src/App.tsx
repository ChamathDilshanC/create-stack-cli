...
function App() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-950 px-4 text-center text-slate-100">
      <h1 className="text-3xl font-bold tracking-tight">React + TypeScript</h1>
      <button
        type="button"
      ...
      <p className="text-sm text-slate-400">
        Edit <code className="rounded bg-slate-800 px-1.5 py-0.5 text-slate-200">src/App.tsx</code> and save to test HMR.
      </p>
    </main>
  );
}
