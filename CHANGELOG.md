...
* cap the banner box at a fixed max width ([33c30f0](https://github.com/ChamathDilshanC/create-stack-cli/commit/33c30f068bcece5267c2e6341e6ba1ccaef30fdf))
...
* custom brand colors + embed the logo in the banner box itself ([db788f4](https://github.com/ChamathDilshanC/create-stack-cli/commit/db788f48342659192d8a6cb2566bca62de0930ce))
...
* exclude pages/ from Nuxt's enterprise structure to prevent router match errors ([55d91aa](https://github.com/ChamathDilshanC/create-stack-cli/commit/55d91aa9e166ec1a76cf33a6c614c3c6724a5ec5))
